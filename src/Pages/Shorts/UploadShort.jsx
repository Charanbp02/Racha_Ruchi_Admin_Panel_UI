...
import { Upload, Clock, Film, Calendar, Plus, X } from "lucide-react";
...
function UploadShort() {
  ...
  const categories = ["Cooking", "Tips", "Beverages", "Breakfast", "Dessert", "Health", "Fitness", "Lifestyle"];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">Upload new short video content</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="e.g., cooking, quick, tips"
                />
              </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-xl font-medium hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
